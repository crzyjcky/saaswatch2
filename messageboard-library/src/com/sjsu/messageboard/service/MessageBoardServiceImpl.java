...
public class MessageBoardServiceImpl implements MessageBoardService {
	...
	private DebugLogger debugLogger = Library.getInstance().getDebugLogger(MessageBoardServiceImpl.class);
	...
	public List<Message> listMessages() {
		...
		debugLogger.debug(customUser.getTenantId() + " - " + customUser.getUsername() + " - " + "listMessages");
